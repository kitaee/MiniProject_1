...
private:
	...
	void recvLaunchMissile(shared_ptr<NOM> nomMsg);
	void recvUplinkInfo(shared_ptr<NOM> nomMsg);
	//郴何 荐脚 贸府
	void recvSendScenarioAck(shared_ptr<NOM> nomMsg);
	void recvDownlinkInfo(shared_ptr<NOM> nomMsg);
